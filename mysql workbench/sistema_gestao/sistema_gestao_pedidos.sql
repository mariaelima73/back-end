...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `fk_pedido_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `pedidos` VALUES (2,6,'Case Samsung S23',2,'2024-12-01'),(4,2,'Case iPhone 12',1,'2024-12-01'),(5,1,'Case Redmi 13 Note',2,'2024-11-01');
