...
CREATE TABLE `estoque` (
  ...
  KEY `fk_estoque_produto_idx` (`produto_id`),
  CONSTRAINT `fk_estoque_produto` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `estoque` VALUES (1,25),(2,22),(3,23),(4,23),(5,16),(6,17),(7,25),(8,24),(9,22),(10,23);
